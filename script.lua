...
Section:NewButton("Kill", "Killing you'r self", function()
    game:GetService("Workspace").Rugonya.HumanoidRootPart.CFrame = CFrame.new(73, -501, 314)
end)
...
Section:NewButton("Teleport to bus", "Teleport's you to the bus", function()
    game:GetService("Workspace").Rugonya.HumanoidRootPart.CFrame = CFrame.new(954.035767, 159.75238, 46.1089478, 0, 0, -1, 0, 1, 0, 1, 0, 0)
end)
Section:NewButton("Teleport to spawn", "Teleport's you to the spawn", function()
    game:GetService("Workspace").Rugonya.HumanoidRootPart.CFrame = CFrame.new(180.282959, 32.0924606, 276.460297, 1, -6.45304326e-08, -6.93859033e-14, 6.45304326e-08, 1, 4.2609738e-08, 6.66362785e-14, -4.2609738e-08, 1)
end)
Section:NewButton("Teleport to teatr", "Teleport's you to the teatr", function()
    game:GetService("Workspace").Rugonya.HumanoidRootPart.CFrame = CFrame.new(380.763977, 42.0924492, 112.729065, 0.645273864, -7.59138459e-08, 0.763951361, 2.61837911e-08, 1, 7.72537874e-08, -0.763951361, -2.98467064e-08, 0.645273864)
end)
Section:NewButton("Teleport to safe", "Teleport's you to the safe", function()
    game:GetService("Workspace").Rugonya.HumanoidRootPart.CFrame = CFrame.new(15.3201714, 8.09245205, 313.383545, 0.563495338, -6.44033946e-08, -0.826119244, 2.79598158e-08, 1, -5.88875899e-08, 0.826119244, 1.00847393e-08, 0.563495338)
end)
Section:NewButton("Teleport to amogus", "Teleport's you to the amogus", function()
    game:GetService("Workspace").Rugonya.HumanoidRootPart.CFrame = CFrame.new(345.183563, 9.09245205, 226.469315, -0.126799092, 4.25282316e-08, -0.991928399, -1.17208296e-08, 1, 4.43725803e-08, 0.991928399, 1.72526278e-08, -0.126799092)
end)
Section:NewButton("Teleport to safe in final", "Teleport's you to the safe in final", function()
    game:GetService("Workspace").Rugonya.HumanoidRootPart.CFrame = CFrame.new(-410.067719, 18.8924503, 651.869202, 0.975863636, 5.72275027e-08, -0.218380734, -4.03397102e-08, 1, 8.17903896e-08, 0.218380734, -7.1006852e-08, 0.975863636)
end)
